...
Please see table \@ref(tab:benchmarkdf) for all the models and their root mean squared error (RMSE) on the validation set.
...
train_gbm_rmse_vs_num_trees <- function(shrinkage, rerun) {
  ...
  count <- 1
  filename_vec1 <- c("models/gbm_shrinkage_")
  filename_vec1 <- append(filename_vec1, gsub('\\.', 'point', toString(shrinkage)) )
