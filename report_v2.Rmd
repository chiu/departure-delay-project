...
```
, dest is the destination airport code. sched_dep_time_num_minute is the number of minutes since the beginning of a given day for that flight. model is the plane model.
